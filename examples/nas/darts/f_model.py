...
with open("darts.json") as f:
    fixed_arc = json.load(f)
class LayerChoice(nn.Module):
  def __init__(self, op_choices, key, **kwargs):
    super().__init__()
...
class Node(nn.Module):
    def __init__(self, node_id, num_prev_nodes, channels, num_downsample_connect):
        ...
        self.input_switch = InputChoice(choose_from=choice_keys, n_chosen=2, key="{}_switch".format(node_id))
