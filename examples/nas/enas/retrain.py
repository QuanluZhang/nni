...
import datasets
import utils
from f_macro import GeneralNetwork
...
if __name__ == "__main__":
    ...
    #model.load_state_dict(torch.load('retrain_checkpoint.pth'))

    '''configure_list = [{
        'sparsity': 0.7,
        'op_types': ['Conv2D'],
        #'op_names': ['layers.11.mutable.ops.0.preproc.conv.1']
    }]
    ...
    torch.save(model.state_dict(), 'retrain_checkpoint.pth')
